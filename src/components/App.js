...
export default class App extends Component{
  ...
  //DELETE METHOD
  //function takes album id from albums list and then delete the album from albums list and update state
  ...
  addAlbumToList = (userId, title) => {
    ...
    alert("New Album added successfully in the bottom of the list");
  }
